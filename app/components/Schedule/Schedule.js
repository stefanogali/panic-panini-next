    ...
    >
      <Container customClasses="pb-2.5 h-full">
        <div className="flex flex-col items-center text-white pt-4">
          <h2 className="text-2xl font-bold lg:text-4xl">Schedule</h2>
          <h4 className="text-base p-2">Here is our event schedule!</h4>
        </div>
        <div
        ...
        >
          <p className="text-yellow-btn-primary border-yellow-btn-primary backdrop-blur-2xl p-2 text-sm font-bold border-2 rounded-xl cursor-pointer">
            Show More
          </p>
          <ArrowBottom />
        </div>
