...
export default function ContactUs() {
  ...
  return (
    <section
      id="contacts"
      className={`relative flex flex-col items-center w-full mt-16 mx-auto max-w-[150rem] lg:mt-56 lg:flex-row reveal${
        isIntersecting ? " visible" : ""
      }`}
      ref={sectionRef}
    >
      <Image
        className="hidden lg:block lg:max-w-lg xl:max-w-xl"
        src="/contacts.jpg"
        width={750}
        height={533}
        alt="Band playing"
