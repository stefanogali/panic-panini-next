...
export default function Intro() {
  ...
  return (
    <section
      id="intro"
      className={`relative flex flex-col items-center h-[calc(100vh-3rem)] w-full overflow-hidden max-h-[93rem] min-h-[40rem] lg:h-screen lg:flex-row lg:justify-start`}
      ref={sectionRef}
    >
      <BandIdentity />
